...
test_arg.add_argument('--saveFigInt', type=list, default=[150,250], help='')
test_arg.add_argument('--saveFigIntLow', type=int, default=150, help='')
test_arg.add_argument('--saveFigIntUp', type=int, default=250, help='')
test_arg.add_argument('--ifsaveHistInterval', type=str2bool, default=False, help='if every xx games save details of the episode')
test_arg.add_argument('--saveHistInterval', type=int, default=100, help='every xx games save details of the play')
